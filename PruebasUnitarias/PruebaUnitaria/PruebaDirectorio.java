...
public class PruebaDirectorio  extends TestCase
{
    ...
    public void testAgregarVictima()
    {
        ...
        directorio.agregarVictima(new Victima("pepe", "perez", "1000", "Bogota", "Fue secuestrado por la policia mientras marchaba de forma pacifica"));
        ...
        directorio.agregarVictima(new Victima("lolita", "luna", "1001", "cali", "Fue asesina por policias despues de haber sido abusada sexualmente"));
