...
public class Directorio {
    ...
    public void cargarDirectorio(String pArchivo) {
        try {
            ...
            while (lector.readRecord()) // Iterar� hasta que no encuentre mas lineas.
            {
                ...
                Victima victimaArchivo = new Victima(nombres, apellidos, id, ciudadOrigen, hechos); //Se crea la victima en el sistema segun el archivo .csv
    ...
    public String reporteCiudades()
    {
        String reporte = "";
        ArrayList<String> ciudadRevisada = new ArrayList<String>();
    ...
    public boolean yaEstaRevisadaCiudad(ArrayList<String> listaCiudades, String pCiudadVictima)
    {
        boolean encontrada = false;

        for (int i = 0; i < listaCiudades.size(); i++)
        {
            String ciudadActual = listaCiudades.get(i);

            if(ciudadActual.compareToIgnoreCase(pCiudadVictima) == 0)
            {
                encontrada = true;
            }
        }
